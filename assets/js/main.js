...
(function ($) {
 ...
 /*----------------------------------------------
  ...
  $("#play-video").on("click", function (e) {
    ...
    $("#video-overlay").append('<iframe width="560" height="315" src="https://www.youtube.com/embed/oa7RIR_4dmA?si=JujHk1XUHB4sl4Ov" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
  });
